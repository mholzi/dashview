...
export function saveSettings(panel, settingsStore, debugLog) {
  ...
  settingsStore.update({
    ...
    enabledDoors: panel._enabledDoors,
    ...
    doorOpenTooLongMinutes: panel._doorOpenTooLongMinutes,
    windowOpenTooLongMinutes: panel._windowOpenTooLongMinutes,
    garageOpenTooLongMinutes: panel._garageOpenTooLongMinutes,
    roofWindowOpenTooLongMinutes: panel._roofWindowOpenTooLongMinutes,
    coverOpenTooLongMinutes: panel._coverOpenTooLongMinutes,
    lockUnlockedTooLongMinutes: panel._lockUnlockedTooLongMinutes,
