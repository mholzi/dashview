...
export class PopupManager {
    constructor(panel) {
      ...
      // The component initializer registry now lives here.
    ...
    _setupEventListeners() {
      // Listen for hash changes to open/close popups
      window.addEventListener('hashchange', () => this.handleHashChange(), true);
  
      // Allow popups to be closed by clicking the background overlay
    ...
    createPopupFromTemplate(popupId, popupType, content) {
      ...
      // Inject dynamic cards (covers, lights, etc.) for rooms
