    ...
    _updateMediaPlayerDisplay(popup, entityId) {
        ...
        if (img) {
            ...
            if (entityPicture) {
                ...
                img.src = 'data:image/svg+xml,<svg xmlns="http://www.w3.org/2000/svg" width="100" height="100" viewBox="0 0 100 100"><rect width="100" height="100" fill="%23f5f5f5"/><text x="50" y="55" text-anchor="middle" font-family="Arial" font-size="12" fill="%23999">Kein Cover vorhanden</text></svg>';
                img.style.display = 'block';
            }
        }
