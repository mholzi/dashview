...
class DashViewStore:
    ...
    def get_weather_entity(self, default=None):
    ...
    def get_music_config(self):
        ...
        return self._data.get("music_config", {})

    async def async_set_music_config(self, config: dict):
    ...
    def get_temperature_config(self):
        ...
        return self._data.get("temperature_config", {})

    async def async_set_temperature_config(self, config: dict):
        """Set the temperature configuration."""
        self._data["temperature_config"] = config
        await self.async_save(self._data)
    ...
    def get_scenes_config(self):
        """Get the scenes configuration."""
        return self._data.get("scenes_config", {})

    async def async_set_scenes_config(self, config: dict):
        """Set the scenes configuration."""
        self._data["scenes_config"] = config
        await self.async_save(self._data)
